			...
			<div class="custom-settings">
				...
				<form action="">
					...
					<select
						name=""
						id=""
						@change="flashMessage.setStrategy($event.target.value)"
						v-model="userData.strategy"
					>
						<option value="single" selected>single</option>
						<option value="multiple">multiple</option>
					</select>
					<select name="" id="" v-model="userData.position">
						<option value="right bottom " selected
							>right bottom</option
						>
					...
					<input
						...
						name=""
						id=""
						placeholder="Time the message will live in ms"
						v-model.number="userData.time"
					/>
					<button
						type="button"
						name="button"
...
#app {
	...
	min-width: 100vw;
	min-height: 100vh;
	background: linear-gradient(0.25turn, #a224dc, #3624dc);
